...
public sealed class InMemoryUserRepository : IUserRepository
{
    private static readonly List<User> Users = new()
    {
        ...
        new User(Guid.Parse("00000000-0000-0000-0000-000000000002"), "user2@myspot.io", "secret", "Adam Smith", "user", "manager"),
        new User(Guid.Parse("00000000-0000-0000-0000-000000000003"), "user3@myspot.io", "secret", "Tom Jones", "user", "boss")
    };
